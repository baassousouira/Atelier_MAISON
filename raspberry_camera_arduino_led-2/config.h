...
// ----------------------------------------------------------------------
// HEARTBEAT / CLASSIFICATION (pour l'app React de votre camarade)
// ----------------------------------------------------------------------
// Ce Raspberry est le "fixe" (192.168.1.4) d'après sa classification :
// caméra + photorésistance + bouton + LED, PAS de servo.
#define A_UN_SERVO false
#define HEARTBEAT_INTERVAL_SECONDS 5

// À quelle fréquence on vérifie si la surveillance est armée/désarmée
// (en secondes) — indépendant du heartbeat, mais on peut réutiliser le
// même rythme pour l'instant.
