...
/*
 * Retourne la dernière valeur de luminosité connue (dernier "valeur"
 * reçu dans un événement photorésistance), utile pour le heartbeat qui
 * doit envoyer la vraie mesure. Retourne -1.0 si aucune valeur n'a
 * encore été reçue depuis le démarrage.
 */
