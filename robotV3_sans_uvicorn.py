...
# Serveur central : le Raspberry vient LIRE la dernière commande.
# Aucun serveur FastAPI/Uvicorn ne tourne sur le Raspberry.
...
def appliquer_commande(command, speed):
    ...
    if not robotEnabled or not servoEnabled:
        ...
        print(
            "[Robot] commande refusée : robot ou servo désactivé"
        )
...
try:
    ...
    while True:
        ...
        try:
            ...
            # -------------------------------------------------
            # Vérification HTTP puis transformation en JSON
            # -------------------------------------------------
